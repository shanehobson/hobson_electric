...
function sendData(data) {
  ...
  // Set up our request
  XHR.open("POST", "https://boiling-wildwood-70104.herokuapp.com/");
...
document
  .querySelector(".customer-contact-form")
  .addEventListener("submit", (e) => {
    ...
    formBody.innerHTML =
      "<br><h4>Thank you for your message!</h4><br><h4>We'll get back to you as soon as possible. If this is an emergency, please call us at (765) 362-3756.</h4><br><br>";
